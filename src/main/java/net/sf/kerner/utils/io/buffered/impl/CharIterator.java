 ...
 * 
 * 
 * A {@code CharIterator} provides methods for reading characters in an iterator
 * like manner.
 * <p>
 * A {@code CharIterator} is convenient to use, but brings worse performance
 * compared to {@link BufferedStringReader}.
 * </p>
 * 
 * <p>
...
public class CharIterator extends AbstractBufferedReader implements
	 ...
	 * <p>
	 * Use this constructor to pass {@link java.io.Reader} that is used by
