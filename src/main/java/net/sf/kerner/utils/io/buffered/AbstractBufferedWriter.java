...
/**
 * 
 * An {@code AbstractBufferedWriter} provides a prototype implementation for
 * {@link GenericBufferedWriter} with convenient constructor methods to
 * instantiate this writer.
 * 
...
public abstract class AbstractBufferedWriter implements GenericBufferedWriter {
	 ...
	 * @throws IOException if opening file for writing fails
	 */
