...
public class TestBufferedStringReader {
	...
	/**
	 * Test method for
	 * {@link net.sf.kerner.commons.io.buffered.BufferedStringReader#BufferedStringReader(java.io.File)}
	 * .
	 * 
	 * @throws IOException
	 */
	...
	/**
	 * Test method for
	 * {@link net.sf.kerner.commons.io.buffered.BufferedStringReader#close()}.
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link net.sf.kerner.commons.io.buffered.BufferedStringReader#nextChars(int)}
	 * .
	 * 
	 * @throws IOException
	 */
	...
	/**
	 * Test method for
	 * {@link net.sf.kerner.commons.io.buffered.BufferedStringReader#nextChars()}
	 * .
	 * 
	 * @throws IOException
	 */
	...
	/**
	 * Test method for
	 * {@link net.sf.kerner.commons.io.buffered.BufferedStringReader#nextLine()}
	 * .
	 * 
	 * @throws IOException
	 */
	...
	public final void testNextLine01() throws IOException {
		final BufferedStringReader reader = new BufferedStringReader(
				new StringReader("aa" + IOUtils.NEW_LINE_STRING + "bb"));
		final String s2 = String.valueOf(reader.nextLine());
		reader.close();
		assertEquals("aa", s2);
	}
	...
	/**
	 * Test method for
	 * {@link net.sf.kerner.commons.io.buffered.BufferedStringReader#nextChar()}
	 * .
	 * 
	 * @throws IOException
	 */
	...
	public final void exampleReadFromAFile() throws IOException {
		...
		final BufferedStringReader reader = new BufferedStringReader(new File(
				"src/test/resources/smallTestFile.txt"));
